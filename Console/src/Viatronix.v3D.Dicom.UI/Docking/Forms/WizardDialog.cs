// $Id: WizardDialog.cs,v 1.1 2005/10/11 14:40:47 mkontak Exp $
//
...
namespace Viatronix.v3D.Dicom.UI.Docking.Forms
{
  /// <summary>
  ...
  public class WizardDialog : System.Windows.Forms.Form
  {
    ...
    protected string m_cachedTitle;
    protected TitleModes m_titleMode;
    ...
    private void InitializeComponent()
    {
      ...
      this.wizardControl = new Viatronix.v3D.Dicom.UI.Docking.Controls.WizardControl();
      this.SuspendLayout();
      // 
      // wizardControl
      // 
      ...
      this.wizardControl.WizardPageEnter += new Viatronix.v3D.Dicom.UI.Docking.Controls.WizardControl.WizardPageHandler(this.OnWizardPageEnter);
      ...
      this.wizardControl.WizardPageLeave += new Viatronix.v3D.Dicom.UI.Docking.Controls.WizardControl.WizardPageHandler(this.OnWizardPageLeave);
    ...
    {
      get { return m_titleMode; }
            
      set
      {
        if (m_titleMode != value)
        {
          m_titleMode = value;
          ApplyTitleMode();
        }
...
// $Log: WizardDialog.cs,v $
// Revision 1.1  2005/10/11 14:40:47  mkontak
// Initial checkin
//
// $Header: /CVS/cvsRepository/V3D/src/Viatronix.v3D.Dicom.UI/Docking/Forms/WizardDialog.cs,v 1.1 2005/10/11 14:40:47 mkontak Exp $
// $Id: WizardDialog.cs,v 1.1 2005/10/11 14:40:47 mkontak Exp $
