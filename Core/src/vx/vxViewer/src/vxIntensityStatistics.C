// $Id: vxIntensityStatistics.C,v 1.2 2006/01/20 18:09:00 geconomos Exp $
//
 ...
 * Default constructor
 */
vxIntensityStatistics::vxIntensityStatistics()
{
  Clear();
} // vxIntensityStatistics()
 ...
 */
vxIntensityStatistics::vxIntensityStatistics( const vxIntensityStatistics & other )
{
  *this = other;
} // copy constructor
 ...
 */
vxIntensityStatistics & vxIntensityStatistics::operator=( const vxIntensityStatistics & other )
{
  if ( this != & other )
  {
 ...
 */
void vxIntensityStatistics::Clear()
{
  m_vDensities.clear();
  m_iMinimum = 0;
  m_iMaximum = 0;
 ...
 * @param new value
 */
void vxIntensityStatistics::Add( const int2 iValue )
{
 ...
 */
const uint4 vxIntensityStatistics::GetNumberEntries() const
{
...
/**
 * Compute the minimum, maximum, average, and standard deviation
 */
void vxIntensityStatistics::Compute()
{
  // clear out statistics first
  m_iMinimum = 0;
  m_iMaximum = 0;
  m_fAverage = 0.0F;
  m_fStandardDeviation = 0.0F;
  ...
  if (m_vDensities.size() > 0)
  {
    ...
    m_iMinimum = m_vDensities.front();
    m_iMaximum = m_vDensities.front();
    float4 fSum(0.0F);
...
// code review
//
// Revision 1.1  2003/05/08 12:16:07  frank
...
// Initial version.
//
// $Header: /CVS/cvsRepository/V3D/src/vxViewer/src/vxIntensityStatistics.C,v 1.2 2006/01/20 18:09:00 geconomos Exp $
// $Id: vxIntensityStatistics.C,v 1.2 2006/01/20 18:09:00 geconomos Exp $
