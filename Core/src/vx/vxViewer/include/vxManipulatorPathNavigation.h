// $Id: vxManipulatorPathNavigation.h,v 1.1 2004/04/06 18:19:30 frank Exp $
//
...
#ifndef vxManipulatorPathNavigation_h
#define vxManipulatorPathNavigation_h
 ...
 */
class VX_VIEWER_DLL vxManipulatorPathNavigation : public vxManipulator
{
// Member Functions
public:

  /// Constructor
  vxManipulatorPathNavigation( vxEnvironment & environment );

  /// Destructor
  ~vxManipulatorPathNavigation() {};
...
}; // class vxManipulatorPathNavigation


#endif // vxManipulatorPathNavigation_h


// $Log: vxManipulatorPathNavigation.h,v $
...
//
// $Header: /CVS/cvsRepository/V3D/src/vxViewer/include/vxManipulatorPathNavigation.h,v 1.1 2004/04/06 18:19:30 frank Exp $
// $Id: vxManipulatorPathNavigation.h,v 1.1 2004/04/06 18:19:30 frank Exp $
