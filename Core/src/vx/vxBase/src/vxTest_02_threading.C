// $Id: vxTest_02_threading.C,v 1.3 2006/03/30 15:10:35 geconomos Exp $
//
 ...
 * @return success
 */
bool vxTest_02_threading::UnitTest(std::ostream & stream)
//*******************************************************************
{
  string sLabel("Class");
 ...
 * @return success
 */
bool vxTest_02_threading::PerformanceTest(std::ostream & stream)
//*******************************************************************
{
...
//
// $Header: /CVS/cvsRepository/V3D/src/vxBase/src/vxTest_02_threading.C,v 1.3 2006/03/30 15:10:35 geconomos Exp $
// $Id: vxTest_02_threading.C,v 1.3 2006/03/30 15:10:35 geconomos Exp $
