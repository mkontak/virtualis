...
namespace Viatronix.Enterprise.Entities
{
  ...
  public class SystemSetting : Setting
  {
    ...
    public static new SystemSetting Create(string xml)
    {
    ...
    /// <returns>LicenseSetting</returns>
    public static new SystemSetting Create(XmlNode node)
    {
      SystemSetting setting = new SystemSetting();

      if (setting == null)
        throw new OutOfMemoryException("Failed to allocate the SystemSetting");
