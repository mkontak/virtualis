...
namespace Viatronix.Enterprise.Entities
{
  ...
  /// <summary>
  /// Implements the UserHistory object from the auditing database
  /// </summary>
  public class UserHistory : Entity
  {
    ...
    /// <summary>
    /// User having the action performed on
    /// </summary>
    ...
    static public UserHistory Create(string xml)
    {
    ...
    /// <param name="xml">The xml to de-serialize.</param>
    /// <returns>Product object.</returns>
    static public UserHistory Create(XmlNode node)
    {
      UserHistory history = new UserHistory();

      if (history == null)
        throw new OutOfMemoryException("Failed to create UserHistory object");
    ...
    public override void Load(XmlNode node)
    {
      ...
      m_user = node.Attributes[Attributes.User].Value.ToString();
    ...
    {
      UserHistory other = obj as UserHistory;
