// $Id: v3D_DataAnnotationCreate.h,v 1.4 2006/10/04 18:29:04 gdavidson Exp $
//
...
// class definition
public ref class DataAnnotationCreate : public IObserver, public IElement
{
// IElement implementation
public:

  /// gets a pointer to the extended element
  virtual System::IntPtr GetElementPtr() { return System::IntPtr(m_pDataAnnotationCreate); }
...
public:
  ...
  /// destructor
  virtual ~DataAnnotationCreate();

  /// finalizer
  !DataAnnotationCreate();

  /// adds an annotation 
  void AddAnnotation( IAnnotationFactory ^ mpFactory );

// data
private:

  vxShareableObject<vxDataAnnotationCreate> * m_pDataAnnotationCreate;
}; // DataAnnotationCreate
...
// Revision History:
// $Log: v3D_DataAnnotationCreate.h,v $
...
//
// $Header: /CVS/cvsRepository/V3D/src/Viatronix.Visualization/v3D_DataAnnotationCreate.h,v 1.4 2006/10/04 18:29:04 gdavidson Exp $
// $Id: v3D_DataAnnotationCreate.h,v 1.4 2006/10/04 18:29:04 gdavidson Exp $