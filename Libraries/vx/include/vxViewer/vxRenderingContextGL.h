// $Id: vxRenderingContextGL.h,v 1.2 2007/10/24 20:14:21 gdavidson Exp $
//
...
/* 
  The vxRenderingContextGL class encapsulates an OpenGL rendering context
*/

#ifndef vxRenderingContextGL_h
#define vxRenderingContextGL_h
...
// class definition
class VX_VIEWER_DLL vxRenderingContextGL : public vxIRenderingContext
{
// functions
public:
  
  /// constructor
  vxRenderingContextGL( const GLFormat & format, const GLPaintDevice * pDevice );
  
  /// destructor
  virtual ~vxRenderingContextGL();
  
  /// creates the GL context
  virtual bool Create( const vxRenderingContextGL * pShareContext = 0 );
  ...
  static const vxRenderingContextGL * GetCurrentContext() { return m_pCurrentContext; }

  /// Win32 specific OpenGL context
  const HGLRC	GetContext() const { return m_hRC; }

  /// Win32 specific OpenGL context
  virtual const HDC GetHDC() const;
...
protected:
  ...
  virtual bool ChooseContext( const vxRenderingContextGL* shareContext = 0 );
...
private:
  ...
  /// copy constructor
  vxRenderingContextGL( const vxRenderingContextGL & other ) {}

  /// assignment operator
  vxRenderingContextGL& operator=( const vxRenderingContextGL & other ) { return *this; }
...
private:
  ...
  /// current context
  static vxRenderingContextGL * m_pCurrentContext;
...
#endif // vxRenderingContextGL_h


// $Log: vxRenderingContextGL.h,v $
// Revision 1.2  2007/10/24 20:14:21  gdavidson
// Implemented Destroy method from vxIRenderingContext
//
...
// Initial revision.
//
// $Header: /CVS/cvsRepository/V3D/src/vxViewer/include/vxRenderingContextGL.h,v 1.2 2007/10/24 20:14:21 gdavidson Exp $
// $Id: vxRenderingContextGL.h,v 1.2 2007/10/24 20:14:21 gdavidson Exp $
