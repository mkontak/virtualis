// $Id: vxRenderingNode.h,v 1.4 2007/06/28 19:34:09 jmeade Exp $
//
 ...
 */
class VX_VIEWER_DLL vxRenderingNode : public vxVisualizationGraphNode
{
// constants
public:
...
public:
  ...
  /// constructor
  vxRenderingNode( vxVisualizationGraph & graph );
  
  /// destructor
  virtual ~vxRenderingNode();

  /// initializes the rendering manager with the specified viewers
  void Initialize( std::vector< vxViewer * > & viewers );
...
// $Log: vxRenderingNode.h,v $
// Revision 1.4  2007/06/28 19:34:09  jmeade
// Merge from CON_3-0 on 2007-06-28; branch code from 2007-06-22
//
// Revision 1.3.2.2  2007/04/10 14:47:01  geconomos
...
// initial revision
//
// $Header: /CVS/cvsRepository/V3D/src/vxViewer/include/vxRenderingNode.h,v 1.4 2007/06/28 19:34:09 jmeade Exp $
// $Id: vxRenderingNode.h,v 1.4 2007/06/28 19:34:09 jmeade Exp $
