// $Id: vxIntensityStatistics.h,v 1.2 2004/08/12 20:25:14 frank Exp $
//
...
#ifndef vxIntensityStatistics_h
#define vxIntensityStatistics_h
...
// class definition
class VX_VIEWER_DLL vxIntensityStatistics
{
// member functions
public:
  ...
  // copy constructor
  vxIntensityStatistics( const vxIntensityStatistics & other );
  
  // assignment operator
  vxIntensityStatistics & operator=( const vxIntensityStatistics & other );
...
}; // class vxIntensityStatistics


#endif // vxIntensityStatistics_h


// $Log: vxIntensityStatistics.h,v $
...
// Initial version.
//
// $Header: /CVS/cvsRepository/V3D/src/vxViewer/include/vxIntensityStatistics.h,v 1.2 2004/08/12 20:25:14 frank Exp $
// $Id: vxIntensityStatistics.h,v 1.2 2004/08/12 20:25:14 frank Exp $
