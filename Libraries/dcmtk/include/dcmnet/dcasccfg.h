...
#include "dcmnet/assoc.h"    /* for T_ASC_Parameters */
#include "dcmnet/dccftsmp.h" /* for class DcmTransferSyntaxMap */
#include "dcmnet/dccfpcmp.h" /* for class DcmPresentationContextMap */
#include "dcmnet/dccfrsmp.h" /* for class DcmRoleSelectionMap */
#include "dcmnet/dccfenmp.h" /* for class DcmExtendedNegotiationMap */
#include "dcmnet/dccfprmp.h" /* for class DcmProfileMap */
