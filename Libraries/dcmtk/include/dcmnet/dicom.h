...
#include "dcmnet/cond.h"		/* condition typedefs */
#include "dcmnet/dcompat.h"	/* compatability routines */
#include "dcmdata/dctypes.h"	/* dcmdata toolkit basic types */
#include "dcmdata/dcuid.h"	/* dcmdata UID definitions */
