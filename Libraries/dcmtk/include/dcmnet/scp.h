...
#include "dcmdata/dctk.h"     /* Covers most common dcmdata classes */
#include "dcmnet/dimse.h"     /* DIMSE network layer */
#include "dcmnet/dcasccff.h"  /* For reading a association config file */
#include "dcmnet/dcasccfg.h"  /* For holding association cfg file infos */
...
#ifdef WITH_OPENSSL
#include "dcmtls/tlstrans.h"
#include "dcmtls/tlslayer.h"
#endif
