...
#define DCM_UnifiedProcedureStepProgressDescription DcmTagKey(0x0074, 0x1006)
#define DCM_UnifiedProcedureStepCommunicationsURISequence DcmTagKey(0x0074, 0x1008)
...
#define DCM_ImplantTemplateGroupName             DcmTagKey(0x0078, 0x0000)
