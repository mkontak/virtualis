...
#include "dcmdata/dcvrus.h"     /* for class DcmUnsignedShort */
#include "dcmdata/dcvrlo.h"     /* for class DcmLongString */
#include "dcmdata/dcvrui.h"     /* for class DcmUniqueIdentifier */
