...
#include "dcmdata/dcvrcs.h"       /* for DcmCodeString */
#include "dcmpstat/dvpstxl.h"     /* for DVPSTextObject_PList */
#include "dcmpstat/dvpsgrl.h"     /* for DVPSGraphicObject_PList */
#include "dcmpstat/dvpsril.h"     /* for DVPSReferencedImage_PList */
