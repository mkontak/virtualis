...
#include "dcmpstat/dvpstyp.h"   /* for enum types */
#include "dcmpstat/dvpsovl.h"   /* for DVPSOverlay_PList */
#include "dcmpstat/dvpsgll.h"   /* for DVPSGraphicLayer_PList */
#include "dcmpstat/dvpsrsl.h"   /* for DVPSReferencedSeries_PList */
#include "dcmpstat/dvpsall.h"   /* for DVPSOverlayCurveActivationLayer_PList */
#include "dcmpstat/dvpsgal.h"   /* for DVPSGraphicObject_PList */
#include "dcmpstat/dvpscul.h"   /* for DVPSCurve_PList */
#include "dcmpstat/dvpsvll.h"   /* for DVPSVOILUT_PList */
#include "dcmpstat/dvpsvwl.h"   /* for DVPSVOIWindow_PList */
#include "dcmpstat/dvpsdal.h"   /* for DVPSDisplayedArea_PList */
#include "dcmpstat/dvpssvl.h"   /* for DVPSSoftcopyVOI_PList */
#include "dcmpstat/dvpspl.h"    /* for DVPSPresentationLUT */
