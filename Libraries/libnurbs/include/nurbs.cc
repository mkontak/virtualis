/*=====================================================================
        File: nurbs.cc
     Purpose:       
    Revision: $Id: nurbs.cc,v 1.1.1.1 2004/03/02 03:58:35 geconomos Exp $
...
*/
template <class T, int N>
int NurbsCurve<T,N>::setTangent(T u, const Point_nD<T,N>& T0) {
...
*/
template <class T, int N>
int NurbsCurve<T,N>::setTangentAtEnd(const Point_nD<T,N>& T0, const Point_nD<T,N>& T1) {
