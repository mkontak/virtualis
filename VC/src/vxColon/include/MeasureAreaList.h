// $Id: MeasureAreaList.h,v 1.2 2006/01/31 14:44:38 frank Exp $
//
...
/**
 * List of area measurements
 */
class MeasureAreaList : public std::list<MeasureArea>
{
// member functions
public:
  ...
  /// Copy constructor
  MeasureAreaList & operator=(const MeasureAreaList & other);
  
  /// Selects a handle based on a 3D position
  bool SelectHandle(const Point<float4> & position);
  
  /// Clears the measure list, resets iterators
  void clear();
  
// data members
public:

  /// A pointer to the last manipulated measurement area.
  MeasureAreaList::iterator m_currentIter;

}; // class MeasureAreaList


// $Log: MeasureAreaList.h,v $
...
//  
// $Header: /CVS/cvsRepository/V3D/src/vxColon/include/MeasureAreaList.h,v 1.2 2006/01/31 14:44:38 frank Exp $
// $Id: MeasureAreaList.h,v 1.2 2006/01/31 14:44:38 frank Exp $
